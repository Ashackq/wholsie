 ...
 */
export function generateOrderShippedTemplate(data: ShippedTemplateData): string {
 ...
 */
export function generateOrderCancelledTemplate(data: CancelledTemplateData): string {
    return `
    <!DOCTYPE html>
    <html>
    <head>
