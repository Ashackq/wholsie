                            ...
                            <div className="col-xxl-4 col-lg-6 col-xl-5 col-md-10 wow fadeInRight">
                                <div className="sign_in_form">
                                    ...
                                    <p className="dont_account">
                                        <a href="#" onClick={(e) => { e.preventDefault(); setMode("otp"); }}>
                                            Login With Mobile OTP <i className="fas fa-long-arrow-right" />
                                        </a>
                                    </p>
                                </div>
                            </div>
                        ...
                        {mode === "otp" && (
                            <div className="col-xxl-4 col-lg-6 col-xl-5 col-md-10 wow fadeInRight">
                                <div className="sign_in_form">
                                    ...
                                    {otpStep === "request" && (
                                        <form onSubmit={handleRequestOtp}>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-xl-12">
                                                    <button type="submit" className="common_btn" disabled={loading}>
                                                        {loading ? "Sending..." : "Request OTP"} <i className="fas fa-long-arrow-right" />
                                                    </button>
                                                </div>
                                            </div>
                                        </form>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-xl-12">
                                                    <div className="single_input">
                                                        ...
                                                        <div className="otp_input_group" style={{ display: "flex", gap: "10px", justifyContent: "center", marginTop: "15px", marginBottom: "20px" }}>
                                                            {Array.from({ length: 6 }).map((_, index) => (
                                                                <input
                                                                    ...
                                                                    onFocus={(e) => {
                                                                        ...
                                                                        e.target.style.boxShadow = "0 0 5px rgba(var(--primary-rgb), 0.3)";
                                                                    }}
                                                                    onBlur={(e) => {
                                    ...
                                    <p className="dont_account">
                                        <a href="#" onClick={(e) => { e.preventDefault(); setMode("password"); setOtpStep("request"); setError(""); }}>
                                            Login With Email Password <i className="fas fa-long-arrow-right" />
                                        </a>
                                    </p>
                                </div>
                            </div>
