...
export default function Footer() {
    ...
    return (
        <footer className="gadget_footer footer_2 mt_55" style={{
                ...
                <div className="row justify-content-between">
                    <div className="col-xl-3 col-md-6 col-lg-3 wow fadeInUp">
                        <div className="footer_2_logo_area">
                            <a href="/" className="footer_logo">
                                <img src="/assets/images/logo/wholesi_white.png" alt="logo" className="img-fluid w-100" />
                            </a>
                            ...
                            <ul>
                                ...
                                <li><a href="https://wa.me/+919209307191" target="_blank" rel="noreferrer"><i className="fab fa-whatsapp"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    <div className="col-xl-2 col-sm-6 col-md-4 col-lg-2 wow fadeInUp">
                        <div className="footer_link">
                            <h3>Company</h3>
                            <ul>
                                <li><a href="/" className="footer-menu_item">Home</a></li>
                                <li><a href="/about" className="footer-menu_item">About Us</a></li>
                                <li><a href="/contact" className="footer-menu_item">Contact Us</a></li>
                            </ul>
                        </div>
                    </div>
                    <div className="col-xl-2 col-sm-6 col-md-4 col-lg-2 wow fadeInUp">
                        <div className="footer_link">
                            ...
                            <ul>
                                {categories.map((category) => (
                                    <li key={category._id}>
                                        <a href={`/products?category=${category.slug}`} className="footer-menu_item">
                                            {category.name}
                                        </a>
                                    </li>
                                ))}
                    ...
                    <div className="col-xl-2 col-sm-6 col-md-4 col-lg-2 wow fadeInUp">
                        <div className="footer_link">
                            <h3>Quick Links</h3>
                            <ul>
                                <li><a href="/privacy-policy" className="footer-menu_item">Privacy Policy</a></li>
                                <li><a href="/shipping-policy" className="footer-menu_item">Shipping</a></li>
                                <li><a href="/terms-conditions" className="footer-menu_item">Terms &amp; Conditions</a></li>
                                <li><a href="/refund-policy" className="footer-menu_item">Cancellation &amp; Refund Policy</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-xl-12">
                            <div className="gadget_footer_copyright">
                                <p>Copyright @ <b>Wholesiii</b> 2025. All right reserved.</p>
                            </div>
                        </div>
                    </div>
                </div>
